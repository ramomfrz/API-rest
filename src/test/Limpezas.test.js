...
test("Validar se o numero do quarto é maior que 1 e menor que 9999", () => {
    expect(ValidacoesService.validaNumeroQuarto(5466)).toBe(true)
});
...
test("Validar se o numero do quarto é maior que 1 e menor que 9999", () => {
    expect(ValidacoesService.validaNumeroQuarto("2467")).toBe(false)
});
...
test("Verificar funcionário responsável pela limpeza", () => {
    expect(ValidacoesService.validaIdFuncionario("5467")).toBe(false)
});